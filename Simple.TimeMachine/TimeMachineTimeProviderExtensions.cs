...
public static class TimeMachineTimeProviderExtensions {
  ...
  public static void Move(this TimeMachineTimeProvider provider, IEnumerable<TimeSpan> steps) {
  ...
  public static void Move(this TimeMachineTimeProvider provider, IEnumerable<DateTimeOffset> exactTimes) {
    ArgumentNullException.ThrowIfNull(provider);
